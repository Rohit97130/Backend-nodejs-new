...
function ShowModel({ isShowModalOpen, setIsShowModalOpen, selectedTheatre }) {
  ...
  console.log("my selectedShow", selectedShow);
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "movie",
      render: (text, data) => {
        return data.movie && data.movie.title
          ? data.movie.title
          : "No movie selected";
      },
    },
